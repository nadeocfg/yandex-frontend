...
var time = date("2017-05-16 13:45").add(24, "hours").subtract(1, "months").add(3, "days").add(15, "minutes");
assert.deepEqual(
  time.value,
  "2017-04-20 14:00",

  'Если к дате "2017-05-16 13:45" ' + "прибавить 24 часа, 3 дня и 15 минут, вычесть 1 месяц, " + 'то получится "2017-04-20 14:00"'
);
